...
public class bbCommand implements CommandExecutor {
    ...
    public bbCommand(Blockbreakerblockplacer main) {
        this.main = main;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (con == false) {
                ...
                main.getLogger().info("Block added to blockBreakers!");
                ...
                main.getLogger().info("Block removed from blockBreakers!");
            }
            //save data to config??
            main.saveConfig();
            return true;
            ...
            main.getLogger().info("Player only command!");
            return true;
        }
    }
}
